...
```{r}
# Remove participant number [masked for anonymity], as we noticed that he had some missing data for the variables necessary for planned analyses. 
...
# Their participant_id is "masked_for_anonymity"

# Creating a new dataset excluding the participant with participant_id "masked_for_anonymity"
my_data_standardised <- subset(my_data_standardised, participant_id != "masked_for_anonymity")
my_data <- subset(my_data, participant_id != "masked_for_anonymity")
