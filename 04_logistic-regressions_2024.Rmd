...
##Computing the logistic regressions again without the covariates of number of treatment sessions, gender, and age following a reviewer comment
#The B at the and of the labels is used to signify that they are aprt of a second set of analyses, where the regressions were conducted without the covariates. 

# Fit the logistic regression model ov1_pv1
log_reg_ov1_pv1_B <- glm(recovered ~ retrospectively_reported_improvement, 
                       data = port_preprocessed_data, 
                       family = binomial)

summary(log_reg_ov1_pv1_B)

odds_ratios_log_reg_ov1_pv1_B <- exp(coef(log_reg_ov1_pv1_B))

odds_ratios_log_reg_ov1_pv1_B


# Fit the logistic regression model ov1_pv2
log_reg_ov1_pv2_B <- glm(recovered ~ retrospectively_treatment_helpful, 
                       data = port_preprocessed_data, 
                       family = binomial)

summary(log_reg_ov1_pv2_B)

odds_ratios_log_reg_ov1_pv2_B <- exp(coef(log_reg_ov1_pv2_B))

odds_ratios_log_reg_ov1_pv2_B


# Fit the logistic regression model ov1_pv1_pv2
log_reg_ov1_pv1_pv2_B <- glm(recovered ~ retrospectively_reported_improvement  + retrospectively_treatment_helpful,
                       data = port_preprocessed_data, 
                       family = binomial)

summary(log_reg_ov1_pv1_pv2_B)

odds_ratios_log_reg_ov1_pv1_pv2_B <- exp(coef(log_reg_ov1_pv1_pv2_B))

odds_ratios_log_reg_ov1_pv1_pv2_B

# Fit the logistic regression model ov2_pv1
log_reg_ov2_pv1_B <- glm(reliable_improvement ~ retrospectively_reported_improvement, 
                       data = port_preprocessed_data, 
                       family = binomial)

summary(log_reg_ov2_pv1_B)

odds_ratios_log_reg_ov2_pv1_B <- exp(coef(log_reg_ov2_pv1_B))

odds_ratios_log_reg_ov2_pv1_B

# Fit the logistic regression model ov2_pv2
log_reg_ov2_pv2_B <- glm(reliable_improvement ~ retrospectively_treatment_helpful, 
                       data = port_preprocessed_data, 
                       family = binomial)

summary(log_reg_ov2_pv2_B)

odds_ratios_log_reg_ov2_pv2_B <- exp(coef(log_reg_ov2_pv2_B))

odds_ratios_log_reg_ov2_pv2_B

# Fit the logistic regression model ov1_pv1_pv2
log_reg_ov2_pv1_pv2_B <- glm(reliable_improvement ~ retrospectively_reported_improvement  + retrospectively_treatment_helpful, 
                       data = port_preprocessed_data, 
                       family = binomial)

summary(log_reg_ov2_pv1_pv2_B)

odds_ratios_log_reg_ov2_pv1_pv2_B <- exp(coef(log_reg_ov2_pv1_pv2_B))

odds_ratios_log_reg_ov2_pv1_pv2_B

# Fit the logistic regression model ov3_pv1
log_reg_ov3_pv1_B <- glm(reliable_recovery ~ retrospectively_reported_improvement, 
                       data = port_preprocessed_data, 
                       family = binomial)

summary(log_reg_ov3_pv1_B)

odds_ratios_log_reg_ov3_pv1_B<- exp(coef(log_reg_ov3_pv1_B))

odds_ratios_log_reg_ov3_pv1_B

# Fit the logistic regression model ov3_pv2
log_reg_ov3_pv2_B <- glm(reliable_recovery ~ retrospectively_treatment_helpful, 
                       data = port_preprocessed_data, 
                       family = binomial)

summary(log_reg_ov3_pv2_B)

odds_ratios_log_reg_ov3_pv2_B <- exp(coef(log_reg_ov3_pv2_B))

odds_ratios_log_reg_ov3_pv2_B

# Fit the logistic regression model ov3_pv1_pv2
log_reg_ov3_pv1_pv2_B <- glm(reliable_recovery ~ retrospectively_reported_improvement  + retrospectively_treatment_helpful, 
                       data = port_preprocessed_data, 
                       family = binomial)

summary(log_reg_ov3_pv1_pv2_B)

odds_ratios_log_reg_ov3_pv1_pv2_B <- exp(coef(log_reg_ov3_pv1_pv2_B))

odds_ratios_log_reg_ov3_pv1_pv2_B
